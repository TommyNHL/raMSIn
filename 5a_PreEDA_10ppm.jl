...
df24_top17 = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\noSTDtop17_dbMSIn10ppm.csv", DataFrame)
    ...
    df24_train = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_train.csv", DataFrame)[:,top17_4clusters]
    df24_ext = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_ext.csv", DataFrame)[:,top17_4clusters]
    df24_ingested = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_ingested.csv", DataFrame)[:,top17_4clusters]
    df24_FNA = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_FNA.csv", DataFrame)[:,top17_4clusters] 
    ...
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_train_dbMSIn10ppm4nonInDI.csv"
    CSV.write(savePath, df24_train)
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_ext_dbMSIn10ppm4nonInDI.csv"
    CSV.write(savePath, df24_ext)
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_ingested_dbMSIn10ppm4nonInDI.csv"
    CSV.write(savePath, df24_ingested)
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_FNA_dbMSIn10ppm4nonInDI.csv"
    CSV.write(savePath, df24_FNA)


df22_top17 = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\noSTDtop17_dbMSIn10ppm_nonInDI.csv", DataFrame)
    ...
    df22_DI = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_DirectIn\\0_dbMSI_10ppm\\df10ppm_ROI_for_ML_Opti_DirectIn.csv", DataFrame)[:,top17_2clusters]

    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_nonInDI_dbMSIn10ppm4nonInDI.csv"
...
size(df24_train, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_train_dbMSIn10ppm4nonInDI_log.csv"
    CSV.write(savePath, df24_train)
    ...
    describe(df24_train)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_train_dbMSIn10ppm4nonInDI_norm.csv"
    CSV.write(savePath, df24_train)
...
size(df24_ext, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_ext_dbMSIn10ppm4nonInDI_log.csv"
    CSV.write(savePath, df24_ext)
    ...
    describe(df24_ext)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_ext_dbMSIn10ppm4nonInDI_norm.csv"
    CSV.write(savePath, df24_ext)
...
size(df24_ingested, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_ingested_dbMSIn10ppm4nonInDI_log.csv"
    CSV.write(savePath, df24_ingested)
    ...
    describe(df24_ingested)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_ingested_dbMSIn10ppm4nonInDI_norm.csv"
    CSV.write(savePath, df24_ingested)
...
size(df24_FNA, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_FNA_dbMSIn10ppm4nonInDI_log.csv"
    CSV.write(savePath, df24_FNA)
    ...
    describe(df24_FNA)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_FNA_dbMSIn10ppm4nonInDI_norm.csv"
    CSV.write(savePath, df24_FNA)
...
size(df22_DI, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_nonInDI_dbMSIn10ppm4nonInDI_log.csv"
    CSV.write(savePath, df22_DI)
    ...
    describe(df22_DI)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\df_nonInDI_dbMSIn10ppm4nonInDI_norm.csv"
    CSV.write(savePath, df22_DI)
