...
df24_top18 = CSV.read("H:\\3_output_raMSIn\\noSTDtop18_10ppm.csv", DataFrame)
    ...
    df24_train = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_train.csv", DataFrame)[:,top18_4clusters]
    df24_ext = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_ext.csv", DataFrame)[:,top18_4clusters]
    df24_FNA = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ROI4_for_ML_Opti_FNA.csv", DataFrame)[:,top18_4clusters]
    ...
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_train24.csv"
    CSV.write(savePath, df24_train)
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ext24.csv"
    CSV.write(savePath, df24_ext)
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_FNA24.csv"
...
size(df24_train, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_train24_log.csv"
    CSV.write(savePath, df24_train)
    ...
    describe(df24_train)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_train24_std.csv"
    CSV.write(savePath, df24_train)
...
size(df24_ext, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ext24_log.csv"
    CSV.write(savePath, df24_ext)
    ...
    describe(df24_ext)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ext24_std.csv"
    CSV.write(savePath, df24_ext)
...
size(df24_FNA, 2)
    ...
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_FNA24_log.csv"
    CSV.write(savePath, df24_FNA)
    ...
    describe(df24_FNA)
    ## save ##
    savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_FNA24_std.csv"
    CSV.write(savePath, df24_FNA)
