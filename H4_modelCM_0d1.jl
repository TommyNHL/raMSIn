...
## input ## predicted0n1
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_train_cbMSIn0d1_norm_0n1.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_ext_cbMSIn0d1_norm_0n1.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_FNA_cbMSIn0d1_norm_0n1.csv", DataFrame)
diDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_Di_cbMSIn0d1_norm_0n1.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_train_cbMSIn0d1_norm_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_ext_cbMSIn0d1_norm_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_FNA_cbMSIn0d1_norm_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\df_Di_cbMSIn0d1_norm_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n36,651"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n7,098"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n6,860"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n40,351"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n2,338"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n1,318"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n794"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n1,625"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\prediction_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n34,381"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n16,835"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n9,780"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n27,705"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_DiWith, cmap = :viridis, cbar = :true, 
        ...
        size = (1400,600), 
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n1,615"], subplot = 2, font(color="white"))
        annotate!(["0"], ["1"], ["FP\n1,809"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n1,415"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n1,218"], subplot = 2, font(color="white"))
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d1\\prediction_FNAnDICM.png")
