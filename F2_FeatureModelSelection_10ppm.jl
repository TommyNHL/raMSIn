...
trainDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_train_dbMSIn10ppm4nonInDI_STDnorm.csv", DataFrame)
trainDEFSDf = trainDEFSDf[:, vcat(1, collect(2:4), collect(6:8), 10, collect(16:17), collect(20:23), end)]
...
extDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ext_dbMSIn10ppm4nonInDI_STDnorm.csv", DataFrame)
extDEFSDf = extDEFSDf[:, vcat(1, collect(2:4), collect(6:8), 10, collect(16:17), collect(20:23), end)]
...
ingestedDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ingested_dbMSIn10ppm4nonInDI_STDnorm.csv", DataFrame)
ingestedDEFSDf = ingestedDEFSDf[:, vcat(1, collect(2:4), collect(6:8), 10, collect(16:17), collect(20:23), end)]
...
fnaDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_FNA_dbMSIn10ppm4nonInDI_STDnorm.csv", DataFrame)
fnaDEFSDf = fnaDEFSDf[:, vcat(1, collect(2:4), collect(6:8), 10, collect(16:17), collect(20:23), end)]
...
diDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_nonInDI_dbMSIn10ppm4nonInDI_STDnorm.csv", DataFrame)
diDEFSDf = diDEFSDf[:, vcat(1, collect(2:4), collect(6:8), 10, collect(16:17), collect(20:23), end)]
...
## save ##
savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\hyperparameterTuning_10ppm_SVM1.csv"
