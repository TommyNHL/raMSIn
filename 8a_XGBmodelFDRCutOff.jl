...
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\df_train24_std_0n1_pTP.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\df_ext24_std_0n1_pTP.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\df_FNA24_std_0n1_pTP.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\df_train24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\df_ext24_std_0n1_postPredict.csv"
CSV.write(savePath, extDEFSDf)

ingestedDEFSDf = vcat(trainDEFSDf, extDEFSDf)
savePath = "H:\\3_output_raMSIn\\df_ingested24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\df_FNA24_std_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n42,978"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n161"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n533"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n47,288"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n2,623"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n15"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n509"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,928"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\prediction_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n40,830"])
        annotate!(["0"], ["1"], ["FP\n15,047"], font(color="white"))
        annotate!(["1"], ["0"], ["FN\n3,331"], font(color="white"))
        annotate!(["0"], ["0"], ["TN\n29,493"])
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\prediction_FNACM.png")
...
## save ##
savePath = "H:\\3_output_raMSIn\\postPredict_tPRfNRfDR_train.csv"
CSV.write(savePath, trainDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\postPredict_tPRfNRfDR_ext.csv"
CSV.write(savePath, extDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\postPredict_tPRfNRfDR_FNA.csv"
CSV.write(savePath, fnaDEFSDf)
...
savefig(TrainOutplotP1toRate, "H:\\3_output_raMSIn\\prediction_P1threshold2TPRFNRFDR.png")
