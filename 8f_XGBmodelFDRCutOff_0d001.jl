...
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_train24_std_0n1_pTP.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_ext24_std_0n1_pTP.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_FNA24_std_0n1_pTP.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_train24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_ext24_std_0n1_postPredict.csv"
CSV.write(savePath, extDEFSDf)

ingestedDEFSDf = vcat(trainDEFSDf, extDEFSDf)
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_ingested24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\df0d001_FNA24_std_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n43,259"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n707"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n252"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n46,742"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n3,095"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n705"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n37"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,238"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\prediction0d001_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        annotate!(["1"], ["1"], ["TP\n36,256"])
        annotate!(["0"], ["1"], ["FP\n29,879"])
        annotate!(["1"], ["0"], ["FN\n7,905"], font(color="white"))
        annotate!(["0"], ["0"], ["TN\n14,661"], font(color="white"))
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\prediction0d001_FNACM.png")
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\postPredict0d001_tPRfNRfDR_train.csv"
CSV.write(savePath, trainDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\postPredict0d001_tPRfNRfDR_ext.csv"
CSV.write(savePath, extDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\postPredict0d001_tPRfNRfDR_FNA.csv"
CSV.write(savePath, fnaDEFSDf)
...
savefig(TrainOutplotP1toRate, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d001\\prediction0d001_P1threshold2TPRFNRFDR.png")
