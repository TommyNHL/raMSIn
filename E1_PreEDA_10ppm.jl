...
## import all data ##
df24_top17 = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\noSTDtop22.csv", DataFrame)
    ...
    df24_train = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ROI_for_ML_Opti_train_10ppm.csv", DataFrame)[:,top17_4clusters]
    df24_ext = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ROI_for_ML_Opti_ext_10ppm.csv", DataFrame)[:,top17_4clusters]
    df24_ingested = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ROI_for_ML_Opti_ingested_10ppm.csv", DataFrame)[:,top17_4clusters]
    df24_FNA = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ROI_for_ML_Opti_FNA_10ppm.csv", DataFrame)[:,top17_4clusters]
    df22_DI = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ROI_for_ML_Opti_DirectIn_10ppm.csv", DataFrame)[:,top17_4clusters]
...
size(df24_train, 2)
    ...
    describe(df24_train)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_train_dbMSIn10ppm4nonInDI_STDnorm.csv"
...
size(df24_ext, 2)
    ...
    describe(df24_ext)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ext_dbMSIn10ppm4nonInDI_STDnorm.csv"
...
size(df24_ingested, 2)
    ...
    describe(df24_ingested)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_ingested_dbMSIn10ppm4nonInDI_STDnorm.csv"
...
size(df24_FNA, 2)
    ...
    describe(df24_FNA)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_FNA_dbMSIn10ppm4nonInDI_STDnorm.csv"
...
size(df22_DI, 2)
    ...
    describe(df22_DI)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\10ppm\\df_nonInDI_dbMSIn10ppm4nonInDI_STDnorm.csv"
