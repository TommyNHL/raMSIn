...
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_train24_std_0n1_pTP.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ext24_std_0n1_pTP.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_FNA24_std_0n1_pTP.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_train24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ext24_std_0n1_postPredict.csv"
CSV.write(savePath, extDEFSDf)

ingestedDEFSDf = vcat(trainDEFSDf, extDEFSDf)
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_ingested24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\df10ppm_FNA24_std_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n42,956"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n2,786"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n555"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n44,663"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n3,087"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n755"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n45"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,188"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\prediction10ppm_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        annotate!(["1"], ["1"], ["TP\n38,690"])
        annotate!(["0"], ["1"], ["FP\n25,664"])
        annotate!(["1"], ["0"], ["FN\n5,471"], font(color="white"))
        annotate!(["0"], ["0"], ["TN\n18,876"], font(color="white"))
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\prediction10ppm_FNACM.png")
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\postPredict10ppm_tPRfNRfDR_train.csv"
CSV.write(savePath, trainDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\postPredict10ppm_tPRfNRfDR_ext.csv"
CSV.write(savePath, extDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\postPredict10ppm_tPRfNRfDR_FNA.csv"
CSV.write(savePath, fnaDEFSDf)
...
savefig(TrainOutplotP1toRate, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_dbMSI_10ppm\\prediction10ppm_P1threshold2TPRFNRFDR.png")
