...
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_train24_std_0n1_pTP.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_ext24_std_0n1_pTP.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_FNA24_std_0n1_pTP.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_train24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_ext24_std_0n1_postPredict.csv"
CSV.write(savePath, extDEFSDf)

ingestedDEFSDf = vcat(trainDEFSDf, extDEFSDf)
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_ingested24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\df0d01_FNA24_std_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n43,398"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n1,328"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n113"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n46,121"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n3,116"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n778"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n16"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,165"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\prediction0d01_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        annotate!(["1"], ["1"], ["TP\n41,733"])
        annotate!(["0"], ["1"], ["FP\n26,534"])
        annotate!(["1"], ["0"], ["FN\n2,428"], font(color="white"))
        annotate!(["0"], ["0"], ["TN\n18,006"], font(color="white"))
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\prediction0d01_FNACM.png")
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\postPredict0d01_tPRfNRfDR_train.csv"
CSV.write(savePath, trainDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\postPredict0d01_tPRfNRfDR_ext.csv"
CSV.write(savePath, extDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\postPredict0d01_tPRfNRfDR_FNA.csv"
CSV.write(savePath, fnaDEFSDf)
...
savefig(TrainOutplotP1toRate, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d01\\prediction0d01_P1threshold2TPRFNRFDR.png")
