...
## import all data ##
df24_top17 = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\noSTDtop19.csv", DataFrame)
    ...
    df24_train = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ROI_for_ML_Opti_train_0d001.csv", DataFrame)[:,top17_4clusters]
    df24_ext = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ROI_for_ML_Opti_ext_0d001.csv", DataFrame)[:,top17_4clusters]
    df24_ingested = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ROI_for_ML_Opti_ingested_0d001.csv", DataFrame)[:,top17_4clusters]
    df24_FNA = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ROI_for_ML_Opti_FNA_0d001.csv", DataFrame)[:,top17_4clusters]
    df22_DI = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ROI_for_ML_Opti_DirectIn_0d001.csv", DataFrame)[:,top17_4clusters]
...
size(df24_train, 2)
    ...
    describe(df24_train)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_train_cbMSIn0d0014nonInDI_STDnorm.csv"
...
size(df24_ext, 2)
    ...
    describe(df24_ext)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ext_cbMSIn0d0014nonInDI_STDnorm.csv"
...
size(df24_ingested, 2)
    ...
    describe(df24_ingested)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ingested_cbMSIn0d0014nonInDI_STDnorm.csv"
...
size(df24_FNA, 2)
    ...
    describe(df24_FNA)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_FNA_cbMSIn0d0014nonInDI_STDnorm.csv"
...
size(df22_DI, 2)
    ...
    describe(df22_DI)
    ## save ##
    savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_nonInDI_cbMSIn0d0014nonInDI_STDnorm.csv"
