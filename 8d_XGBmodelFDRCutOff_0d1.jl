...
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_train24_std_0n1_pTP.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_ext24_std_0n1_pTP.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_FNA24_std_0n1_pTP.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_train24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_ext24_std_0n1_postPredict.csv"
CSV.write(savePath, extDEFSDf)

ingestedDEFSDf = vcat(trainDEFSDf, extDEFSDf)
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_ingested24_std_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_FNA24_std_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n41,594"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n2,632"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n1,917"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n44,817"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n2,878"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n673"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n254"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,270"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\prediction0d1_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        annotate!(["1"], ["1"], ["TP\n36,871"])
        annotate!(["0"], ["1"], ["FP\n22,005"])
        annotate!(["1"], ["0"], ["FN\n7,290"], font(color="white"))
        annotate!(["0"], ["0"], ["TN\n22,535"])
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\prediction0d1_FNACM.png")
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\postPredict0d1_tPRfNRfDR_train.csv"
CSV.write(savePath, trainDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\postPredict0d1_tPRfNRfDR_ext.csv"
CSV.write(savePath, extDEFSDf)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\postPredict0d1_tPRfNRfDR_FNA.csv"
CSV.write(savePath, fnaDEFSDf)
...
savefig(TrainOutplotP1toRate, "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\prediction0d1_P1threshold2TPRFNRFDR.png")
