...
trainDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_train_cbMSIn0d0014nonInDI_STDnorm.csv", DataFrame)
trainDEFSDf = trainDEFSDf[:, vcat(1, collect(2:4), collect(6:10), 12, 17, collect(19:20), end)]
...
extDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ext_cbMSIn0d0014nonInDI_STDnorm.csv", DataFrame)
extDEFSDf = extDEFSDf[:, vcat(1, collect(2:4), collect(6:10), 12, 17, collect(19:20), end)]
...
ingestedDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_ingested_cbMSIn0d0014nonInDI_STDnorm.csv", DataFrame)
ingestedDEFSDf = ingestedDEFSDf[:, vcat(1, collect(2:4), collect(6:10), 12, 17, collect(19:20), end)]
...
fnaDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_FNA_cbMSIn0d0014nonInDI_STDnorm.csv", DataFrame)
fnaDEFSDf = fnaDEFSDf[:, vcat(1, collect(2:4), collect(6:10), 12, 17, collect(19:20), end)]
...
diDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d001\\df_nonInDI_cbMSIn0d0014nonInDI_STDnorm.csv", DataFrame)
diDEFSDf = diDEFSDf[:, vcat(1, collect(2:4), collect(6:10), 12, 17, collect(19:20), end)]
...
## save ##
savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\hyperparameterTuning_0d001_SVM1.csv"
