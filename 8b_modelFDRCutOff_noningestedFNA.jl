...
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_NonInFNA\\df_noningestedFNA24_std_0n1_pTP.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_NonInFNA\\df_noningestedFNA24_std_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        size = (650,600), 
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n16,565"], font(color="white"))
        annotate!(["0"], ["1"], ["FP\n16,764"], font(color="white"))
        annotate!(["1"], ["0"], ["FN\n24,218"])
        annotate!(["0"], ["0"], ["TN\n27,776"])
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_NonInFNA\\prediction_noningestedFNACM.png")
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_NonInFNA\\postPredict_tPRfNRfDR_noningestedFNA.csv"
CSV.write(savePath, fnaDEFSDf)
...
savefig(FNAOutplotP1toRate, "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_NonInFNA\\prediction_P1threshold2TPRFNRFDR.png")
