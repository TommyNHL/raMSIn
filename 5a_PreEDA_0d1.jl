...
df24_train = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_ROI4_for_ML_Opti_train.csv", DataFrame)[:, top18_4clusters]
...
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_FNA24.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_train24_log.csv"
CSV.write(savePath, df24_train)
...
describe(df24_train)
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_train24_std.csv"
CSV.write(savePath, df24_train)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_ext24_log.csv"
CSV.write(savePath, df24_ext)
...
describe(df24_ext)
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_ext24_std.csv"
CSV.write(savePath, df24_ext)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_FNA24_log.csv"
CSV.write(savePath, df24_FNA)
...
describe(df24_FNA)
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSI_HKU_Ingested4FNA\\0_cbMSI_0d1\\df0d1_FNA24_std.csv"
CSV.write(savePath, df24_FNA)
