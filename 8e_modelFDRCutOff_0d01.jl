...
## input ## predicted0n1
trainDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_train_cbMSIn0d01_norm_0n1.csv", DataFrame)
extDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_ext_cbMSIn0d01_norm_0n1.csv", DataFrame)
fnaDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_FNA_cbMSIn0d01_norm_0n1.csv", DataFrame)
diDEFSDf = CSV.read("H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_Di_cbMSIn0d01_norm_0n1.csv", DataFrame)
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_train_cbMSIn0d01_norm_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_ext_cbMSIn0d01_norm_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_FNA_cbMSIn0d01_norm_0n1_postPredict.csv"
...
## save ##
savePath = "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\df_Di_cbMSIn0d01_norm_0n1_postPredict.csv"
...
heatmap!(["1", "0"], ["0", "1"], CM_TrainWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n37,986"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n6,642"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n5,525"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n40,807"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_ExtWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n2,598"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n931"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n534"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,012"], subplot = 2)
savefig(TrainOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\prediction_trainExtValCM.png")
...
heatmap!(["1", "0"], ["0", "1"], CM_FNAWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n31,978"], subplot = 1)
        annotate!(["0"], ["1"], ["FP\n21,063"], subplot = 1, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n12,183"], subplot = 1, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n23,477"], subplot = 1)
heatmap!(["1", "0"], ["0", "1"], CM_DiWith, cmap = :viridis, cbar = :true, 
        ...
        dpi = 300)
        annotate!(["1"], ["1"], ["TP\n1,847"], subplot = 2)
        annotate!(["0"], ["1"], ["FP\n1,017"], subplot = 2, font(color="white"))
        annotate!(["1"], ["0"], ["FN\n1,183"], subplot = 2, font(color="white"))
        annotate!(["0"], ["0"], ["TN\n2,010"], subplot = 2)
savefig(FNAOutplotCM, "H:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\XGB_ALL\\afterModelSelection\\cbMSIn_0d01\\prediction_FNAnDICM.png")
