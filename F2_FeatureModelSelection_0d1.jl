...
trainDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d1\\df_train_cbMSIn0d14nonInDI_STDnorm.csv", DataFrame)
trainDEFSDf = trainDEFSDf[:, vcat(1, collect(2:5), collect(7:10), 12, collect(15:16), end)]
...
extDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d1\\df_ext_cbMSIn0d14nonInDI_STDnorm.csv", DataFrame)
extDEFSDf = extDEFSDf[:, vcat(1, collect(2:5), collect(7:10), 12, collect(15:16), end)]
...
ingestedDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d1\\df_ingested_cbMSIn0d14nonInDI_STDnorm.csv", DataFrame)
ingestedDEFSDf = ingestedDEFSDf[:, vcat(1, collect(2:5), collect(7:10), 12, collect(15:16), end)]
...
fnaDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d1\\df_FNA_cbMSIn0d14nonInDI_STDnorm.csv", DataFrame)
fnaDEFSDf = fnaDEFSDf[:, vcat(1, collect(2:5), collect(7:10), 12, collect(15:16), end)]
...
diDEFSDf = CSV.read("I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\0d1\\df_nonInDI_cbMSIn0d14nonInDI_STDnorm.csv", DataFrame)
diDEFSDf = diDEFSDf[:, vcat(1, collect(2:5), collect(7:10), 12, collect(15:16), end)]
...
## save ##
savePath = "I:\\3_output_raMSIn\\3_3_Output_raMSIn_HKU_Ingested4ALL\\hyperparameterTuning_0d1_SVM1.csv"
